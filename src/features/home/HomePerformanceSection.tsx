...
export const HomePerformanceSection = (): JSX.Element => {
  return (
    <>
      {" "}
      <section
        className="container trusted-section trusted-section--hero"
        id="company-profile"
      >
        <h2>
          <span className="trusted-section-line trusted-section-line--light">
            TRUSTED BY{" "}
          </span>{" "}
          <span className="trusted-section-line trusted-section-line--dark">
            PROPERTY OWNERS,
            <br />
            HOSPITALITY LEADERS &amp; DEVELOPERS
          </span>
        </h2>
      </section>
